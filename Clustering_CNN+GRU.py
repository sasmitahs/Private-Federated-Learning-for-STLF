...
# Config
MODEL_NAMES = ["dual_simple_ann_fcnn"]
NUM_CLIENTS = 1410
CLIENT_FRAC = 0.15
NUM_ROUNDS = 50
LOCAL_EPOCHS = 5
...
# TimeSeriesDifficultyWeight class
...
for model_name in MODEL_NAMES:
    ...
    for rnd in range(NUM_ROUNDS):
        ...
        local_weights = []
        for cid in tqdm(sampled_clients, desc=f"Training clients (Round {rnd+1})"):
        ...
        checkpoint_path = os.path.join(checkpoint_dir, f"{model_name}_round_{rnd+1}_CNN+GRU-Clustering.pt")
