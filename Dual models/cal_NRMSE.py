...
def evaluate_and_compute_median_metrics(
    MODELS: List[str],
    STRATEGIES: List[str],
    ROUNDS: List[int],
...
if __name__ == "__main__":
    STRATEGIES = ["no-cluster_random","random_sampling"]  # "global_model", "fedAvg_diff", "fedProx_diff", "diff-diff", "scaffold_diff", "fedAvg_diff0", "fedProx", "fedAvg_lr", "scaffold_lr", "diff_lr2", "das11", "das2", "fedAvg_lr", "fedAvg_diffsample_dhc"
    MODELS = ["dual_simple_ann_fcnn","dual_cnn_ann_fcnn"]
    ROUNDS = [40]
    CID = range(101, 1409)
    ...
    evaluate_and_compute_median_metrics(
        MODELS=MODELS,
