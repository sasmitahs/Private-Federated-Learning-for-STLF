...
class DualStreamModel(nn.Module):
    def __init__(self, time_emb_h, time_emb_dr, raw_hidden, cov_hidden, cov_dim,
        ...
        self.use_covariates = use_covariates and (not single_stream)  # disable if single_stream=True
        ...
        # Decoder input size depends on config
        if self.single_stream:
            dec_in = raw_hidden * 2        # only raw encoder output
...
if __name__ == "__main__":
    ...
    run_ablation(df, ablation_configs, out_csv="ablation_results_central.csv")
