...
STRATEGIES = ["AEpublic_k-means_2enc"]# _diff",,"fedProx_diff "diff-diff", scaffold_diff,"fedAvg_diff0","fedProx",,"fedAvg_lr","scaffold_lr" "diff_lr2","das11","das2", "fedAvg_lr","fedAvg_diffsample_dhc"
MODELS = ["simple_cnn"]  # "gru", "moe_lstm", "moe_gru","simple_ann" "moe_lstm", "moe_gru", "lstm", "gru"
# CID = 45
ROUNDS = [40]
