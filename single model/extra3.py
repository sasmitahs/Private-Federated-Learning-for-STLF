...
if __name__ == "__main__":
    STRATEGIES = ["fedAvg_diff"]
    MODELS = ["gru","lstm"]
    BASE_OUTPUT_DIR = "/home/user/DPFL-Sasmita/FL-Baseline-Codes1/predictions21-25"  # Path to predictions CSVs
    METRICS_DIR = "/home/user/DPFL-Sasmita/FL-Baseline-Codes1/metrices21-25"
    CID = range(101, 1409)
    ROUNDS = [40]
